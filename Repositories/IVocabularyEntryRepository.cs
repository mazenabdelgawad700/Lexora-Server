...
public interface IVocabularyEntryRepository
{
  ...
  public Task<ReturnBase<(IQueryable<VocabularyEntry> vocabularies, int totalCount)>> GetVocabularyEntriesPaginatedAsync(GetVocabularyEntriesPaginatedDto getDto);
